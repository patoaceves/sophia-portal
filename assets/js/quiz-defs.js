...
export const QUIZZES = {
  ...
  // ─── Sesión 12 · Quiz Existencialismo (casilla #2, interactivo) ───
  ...
  // ─── Sesión 13 · Quiz Priorización (casilla #2, interactivo) ───
  ...
  // ─── Sesión 14 · Quiz Dialéctica (casilla #2, interactivo) ───
  ...
  "coaching-evaluacion-s17": {
    ...
    introTitle: "Imaginación y Compromiso",
    introLead: [
      "Este quiz tiene 5 preguntas de opción múltiple sobre los marcos As-If en coaching: recolección de información, amplificación de la solución, cambio de perspectiva y el ejercicio de stakeholders.",
      "Al terminar verás tu resultado y podrás revisar las respuestas correctas. Si lo deseas, puedes reintentar el quiz.",
    ],
    preguntas: [
      {
        id: "s17_asif_recoleccion",
        tipo: "choice",
        eyebrow: "Pregunta 1 de 5",
        texto: "Si un coachee te dice “No tengo idea de cómo resolver este conflicto con mi socio”, ¿cuál sería la pregunta de “As-If” más adecuada para recolectar información?",
        opciones: [
          "¿Por qué crees que no tienes la idea?",
          "Supongamos que encuentras un manual titulado “El éxito en las sociedades de [Nombre del Coachee]”. ¿Qué consejo leerías en la página 1?",
          "Deberías imaginar que todo sale bien, ¿no crees?",
          "¿Qué pasaría si tu socio fuera el que tuviera la respuesta?",
        ],
        obligatoria: true,
      },
      {
        id: "s17_asif_amplificacion",
        tipo: "choice",
        eyebrow: "Pregunta 2 de 5",
        texto: "¿Cuál es el principal beneficio neuropsicológico de las preguntas de “Amplificación de la Solución”?",
        opciones: [
          "Que el coachee se canse de imaginar y quiera terminar la sesión.",
          "Activa los sistemas de anticipación y recompensa, fortaleciendo la autoeficacia y la visión estratégica.",
          "Ayuda a que el coachee se dé cuenta de que sus metas son demasiado pequeñas.",
          "Elimina la necesidad de hacer un plan de acción real.",
        ],
        obligatoria: true,
      },
      {
        id: "s17_asif_perspectiva",
        tipo: "choice",
        eyebrow: "Pregunta 3 de 5",
        texto: "En el “Cambio de Perspectiva”, cuando el coachee pide consejo al coach, ¿qué pregunta devuelve el poder al coachee de forma dialéctica?",
        opciones: [
          "Yo no puedo darte consejos, soy tu coach.",
          "Si tú fueras yo en este momento, ¿qué te dirías a ti mismo?",
          "¿Qué crees que diría tu madre sobre esto?",
          "Imagina que eres un superhéroe, ¿cómo lo resolverías?",
        ],
        obligatoria: true,
      },
      {
        id: "s17_asif_stakeholders",
        tipo: "choice",
        eyebrow: "Pregunta 4 de 5",
        texto: "¿Cuál es el objetivo principal del “Ejercicio de los Stakeholders” de Marilyn Atkinson?",
        opciones: [
          "Identificar a quién hay que despedir del proyecto.",
          "Reconectar al coachee con la inspiración original y el propósito trascendente del proyecto.",
          "Calcular las ganancias financieras de los próximos cinco años.",
          "Hacer una lista de todas las personas que podrían estorbar en el proceso.",
        ],
        obligatoria: true,
      },
      {
        ...
        tipo: "choice",
        eyebrow: "Pregunta 5 de 5",
        texto: "Durante la tercera ronda del ejercicio de Stakeholders, el coach proyecta los resultados a 1, 3 y 5 años. ¿Qué efecto tiene esto en el compromiso del coachee?",
        opciones: [
          "Le da miedo el paso del tiempo.",
          "Crea una sensación de progreso sostenido y permite ver el proyecto como el inicio de algo más grande, no como un fin en sí mismo.",
          "Hace que el coachee quiera cambiar de proyecto inmediatamente.",
          "Solo sirve si el coachee tiene buena memoria.",
        ],
        obligatoria: true,
      },
    ],
  ...
  "coaching-evaluacion-s18": {
    ...
    introTitle: "Coaching Trascendental",
    introLead: [
      "Este quiz tiene 5 preguntas de opción múltiple sobre coaching trascendental: la autotrascendencia de Frankl, el daimon de Hillman, el Yo-Tú de Buber, la inmunidad al cambio de Kegan y Lahey, y el trascender e incluir de Wilber.",
      "Al terminar verás tu resultado y podrás revisar las respuestas correctas. Si lo deseas, puedes reintentar el quiz.",
    ],
    preguntas: [
      {
        id: "s18_frankl_autotrascendencia",
        tipo: "choice",
        eyebrow: "Pregunta 1 de 5",
        texto: "Según Viktor Frankl, ¿cuál es la esencia de la existencia humana?",
        opciones: [
          "La acumulación de riqueza y poder.",
          "La autotrascendencia: realizarse a través de la entrega a algo o alguien fuera de uno mismo.",
          "La eliminación total del sufrimiento físico.",
          "El cumplimiento estricto de las normas sociales.",
        ],
        obligatoria: true,
      },
      {
        id: "s18_hillman_daimon",
        tipo: "choice",
        eyebrow: "Pregunta 2 de 5",
        texto: "En la teoría de James Hillman (“The Soul's Code”), ¿qué es el Daimon o la teoría de la bellota?",
        opciones: [
          "Un trauma infantil que dicta el comportamiento adulto.",
          "Una semilla interior que contiene la imagen de nuestro destino singular desde el nacimiento.",
          "Un defecto de carácter que debe ser corregido con coaching.",
      ...
      },
      {
        ...
        tipo: "choice",
        eyebrow: "Pregunta 3 de 5",
        texto: "¿Cuál es la diferencia fundamental entre una relación “Yo-Ello” y una “Yo-Tú” según Martin Buber?",
        opciones: [
          "La relación “Yo-Tú” es solo para familiares y amigos cercanos.",
          "En “Yo-Ello” vemos al otro como un objeto o medio para un fin; en “Yo-Tú” el otro es un ser humano total que nos transforma.",
          "La relación “Yo-Ello” es más eficiente para el coaching de negocios.",
          "No hay diferencia real en la práctica del coaching.",
        ],
        obligatoria: true,
      },
      {
        id: "s18_kegan_inmunidad",
        tipo: "choice",
        eyebrow: "Pregunta 4 de 5",
        texto: "Según Kegan y Lahey (Immunity to Change), ¿por qué las personas se resisten al cambio?",
        opciones: [
          "Por falta de fuerza de voluntad o pereza.",
          "Porque están protegiendo “compromisos ocultos” que mantienen su sistema de seguridad interna.",
          "Porque no han entendido las instrucciones del coach.",
          "Porque el cambio siempre es malo para el cerebro.",
        ],
        obligatoria: true,
      },
      {
        id: "s18_wilber_trascender",
        tipo: "choice",
        eyebrow: "Pregunta 5 de 5",
        texto: "En la Metodología Trascendental, ¿qué significa “Trascender e Incluir” (Wilber)?",
        opciones: [
          "Olvidar el pasado para enfocarse solo en el futuro espiritual.",
          "Integrar los niveles anteriores de conciencia en una totalidad mayor, dándoles un nuevo lugar.",
          "Eliminar el ego para volverse un ser puramente espiritual.",
          "Cambiar de personalidad cada vez que alcanzamos una meta.",
        ],
        obligatoria: true,
      },
    ],
  ...
  "coaching-evaluacion-s19": {
    ...
    introTitle: "Superación de Miedos y Planificación Estratégica",
    introLead: [
      "Este quiz tiene 5 preguntas de opción múltiple sobre la superación de miedos y la planificación estratégica: la planificación tri-posicional (Visionario, Realista, Crítico), los bloqueos creativos y los saboteadores internos.",
      "Al terminar verás tu resultado y podrás revisar las respuestas correctas. Si lo deseas, puedes reintentar el quiz.",
    ],
    preguntas: [
      {
        ...
        tipo: "choice",
        eyebrow: "Pregunta 1 de 5",
        texto: "Durante el ejercicio de Planificación Tri-Posicional, ¿cuál es la función específica del “Crítico”?",
        opciones: [
          "Decirle al Visionario que su idea es imposible y ridícula.",
          "Evaluar el plan creado por el Realista para identificar vacíos y riesgos, sin atacar la visión original.",
          "Decidir si el proyecto vale la pena o si debe cancelarse inmediatamente.",
          "Actuar como el jefe del coachee para presionarlo a trabajar más rápido.",
        ],
        obligatoria: true,
      },
      {
        id: "s19_estado_planificador",
        tipo: "choice",
        eyebrow: "Pregunta 2 de 5",
        texto: "Si un coachee utiliza un tono de voz enérgico y procedimental, y su lenguaje se centra en “hacer”, “estructurar” e “implementar”, ¿en qué estado mental se encuentra?",
        opciones: [
          "Visionario / Soñador.",
          "Crítico / Evaluador.",
      ...
      {
        id: "s19_postura_visionario",
        tipo: "choice",
        eyebrow: "Pregunta 3 de 5",
        texto: "¿Qué postura corporal facilita el acceso al estado mental del “Visionario”?",
        opciones: [
          "Mirada al frente o caminando para “sentir los pasos”.",
          "Postura asimétrica con movimientos oculares analíticos hacia abajo.",
          "Postura erguida, relajada, con la mirada hacia arriba para facilitar la imaginación visual.",
          "Brazos cruzados y ceño fruncido para evaluar errores.",
        ],
        obligatoria: true,
      },
      {
        id: "s19_bloqueo_saturacion",
        tipo: "choice",
        eyebrow: "Pregunta 4 de 5",
        texto: "¿A qué se refiere el bloqueo creativo de “Saturación”?",
        opciones: [
          "A tener demasiadas ideas buenas al mismo tiempo.",
          "A cuando la atención está sobrecargada y no hay espacio mental disponible, volviendo el pensamiento rígido.",
          "A la falta de curiosidad sobre el entorno del proyecto.",
          "A la repetición de viejos hábitos que ya no funcionan.",
        ],
        obligatoria: true,
      },
      {
        id: "s19_miedo_conflicto",
        tipo: "choice",
        eyebrow: "Pregunta 5 de 5",
        texto: "El miedo “Al Conflicto” suele estar asociado al saboteador “Complaciente”. ¿Cuál es su principal preocupación existencial?",
        opciones: [
          "Que el plan no sea lo suficientemente perfecto.",
          "El temor a decepcionar a otros o enfrentar el enojo de personas clave por su cambio.",
          "La falta de recursos económicos para completar el proyecto.",
          "No sentirse capaz de manejar el éxito cuando llegue.",
        ],
        obligatoria: true,
      },
    ],
  ...
  "coaching-fortaleza-mental-s16": {
    titulo: "Quiz: Por qué tu mente se hace más débil",
    introEyebrow: "Pre-sesión · Sesión 16",
    introTitle: "Fortaleza mental",
    introLead: [
      "Este quiz tiene 5 preguntas basadas en el video de trabajo previo sobre cómo se debilita y se entrena la mente: la calma bajo presión, la inoculación al miedo, la armadura cognitiva y la fatiga por decisiones.",
      "Al terminar verás tu resultado y podrás revisar las respuestas correctas. Si lo deseas, puedes reintentar el quiz.",
    ],
    preguntas: [
      {
        ...
        tipo: "choice",
        eyebrow: "Pregunta 1 de 5",
        texto: "¿Cuál es, según el video, la característica que distingue a las personas que intimidan verdaderamente a los demás?",
        opciones: [
          "Son las personas más ruidosas en la sala.",
          "Mantienen la calma cuando los demás pierden el control.",
          "Nunca sienten miedo.",
          "Siempre buscan validación externa.",
        ],
        obligatoria: true,
      },
      {
        id: "s16pre_inoculacion",
        tipo: "choice",
        eyebrow: "Pregunta 2 de 5",
        texto: "El video compara el entrenamiento de fortaleza mental con CrossFit para las emociones. ¿Cuál es una práctica recomendada en el protocolo de “inoculación al miedo”?",
        opciones: [
          "Evitar cualquier situación incómoda para preservar energía.",
          "Exponerse sistemáticamente a pequeñas dosis de incomodidad (por ejemplo, duchas frías cortas).",
          "Delegar decisiones importantes para no sentir estrés.",
          "Leer artículos sobre miedo en lugar de actuar.",
        ],
        obligatoria: true,
      },
      {
        ...
        tipo: "choice",
        eyebrow: "Pregunta 3 de 5",
        texto: "¿Qué componentes conforman el proceso de construcción de “armadura cognitiva” según el video?",
        opciones: [
          "Identificar valores nucleares, recopilar evidencias para esos valores y crear protocolos de respuesta ante críticas.",
          "Huir de cualquier crítica, cambiar de opinión frecuentemente y pedir aprobación.",
          "Publicar defensas largas en redes sociales cada vez que alguien critica.",
          "Aceptar todas las críticas sin filtrarlas.",
        ],
        obligatoria: true,
      },
      {
        ...
        tipo: "choice",
        eyebrow: "Pregunta 4 de 5",
        texto: "En el capítulo sobre “alquimia de la presión”, ¿qué fórmula resume la relación entre presión y desempeño?",
        opciones: [
          "Presión menos preparación iguala rendimiento.",
          "Presión + preparación = rendimiento; presión sin preparación = pánico.",
          "Preparación es irrelevante cuando hay presión.",
          "Presión × ignorancia = éxito.",
        ],
        obligatoria: true,
      },
      {
        ...
        tipo: "choice",
        eyebrow: "Pregunta 5 de 5",
        texto: "¿Qué práctica sugiere el video para reducir la fatiga por decisiones y conservar energía mental?",
        opciones: [
          "Tomar decisiones repetidamente cada hora para mantenerse activo.",
          "Predecidir rutinas diarias y automatizar elecciones menores para reservar energía para decisiones importantes.",
          "Consultar a muchas personas antes de decidir cualquier cosa.",
          "Evitar planificar y vivir al día para mantener flexibilidad.",
        ],
        obligatoria: true,
      },
    ],
  ...
  "coaching-paradoja-felicidad-s17": {
    titulo: "Quiz: La paradoja de la felicidad",
    introEyebrow: "Pre-sesión · Sesión 17",
    introTitle: "La paradoja de la felicidad",
    introLead: [
      "Este quiz tiene 5 preguntas basadas en el video de trabajo previo sobre la paradoja de la felicidad: el World Happiness Report, los mecanismos de Easterlin, el familismo latinoamericano y la comparación social.",
      "Al terminar verás tu resultado y podrás revisar las respuestas correctas. Si lo deseas, puedes reintentar el quiz.",
    ],
    preguntas: [
      {
        id: "s17pre_whr_mexico",
        tipo: "choice",
        eyebrow: "Pregunta 1 de 5",
  ...
  "coaching-experimentar-s18": {
    titulo: "Quiz: No necesitas un plan de 10 años",
    introEyebrow: "Pre-sesión · Sesión 18",
    introTitle: "Experimentar en lugar de planear",
    introLead: [
      "Este quiz tiene 5 preguntas basadas en el video de trabajo previo de Anne-Laure Le Cunff sobre experimentar en lugar de planear a 10 años: la productividad tóxica, los tiny experiments, el affective labeling y la matriz de mindsets.",
      "Al terminar verás tu resultado y podrás revisar las respuestas correctas. Si lo deseas, puedes reintentar el quiz.",
    ],
    preguntas: [
      {
        id: "s18pre_productividad",
        tipo: "choice",
        eyebrow: "Pregunta 1 de 5",
  ...
  "coaching-libre-albedrio-s19": {
    titulo: "Quiz: El misterio del libre albedrío",
    introEyebrow: "Pre-sesión · Sesión 19",
    introTitle: "El misterio del libre albedrío",
    introLead: [
      "Este quiz tiene 5 preguntas basadas en el video de trabajo previo sobre el misterio del libre albedrío: el determinismo neuronal, la evidencia experimental y los modelos alternativos al materialismo.",
      "Al terminar verás tu resultado y podrás revisar las respuestas correctas. Si lo deseas, puedes reintentar el quiz.",
    ],
    preguntas: [
      {
